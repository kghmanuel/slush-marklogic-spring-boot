...
/**
 * Controller that handles the login/logout endpoints expected by the UI
 * generated by https://github.com/marklogic/slush-marklogic-node. In addition,
 * it also proxies all REST API requests to MarkLogic.
 */
@Controller
public class AppController implements ErrorController {
    ...
    /**
     * Assumes that the root URL should use a template named "index", which
     * presumably will setup the Angular app.
     */
    ...
    /**
     * Assumes that Spring Security is configured to use a custom form for a
     * login page with a URL of "/login", with the template for that form being
     * named "login".
     */
    ...
    public void proxySearch(HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        httpProxy.proxy(httpRequest, httpResponse, "Content-length", "Content-type");
    }
    ...
    public void proxyDocuments(HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        httpProxy.proxy(httpRequest, httpResponse, "Content-type", "Location");
    }
